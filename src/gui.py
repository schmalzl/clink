...
from src.menu_callbacks import callback_install_build_deps
...
def display_gui():
    with dpg.viewport_menu_bar():
        ...
        with dpg.menu(label="Build"):
            dpg.add_menu_item(label="Update build dependencies", callback=callback_install_build_deps)
            dpg.add_separator()
    ...
    with dpg.window(label="Console", width=790, height=200, no_close=True, no_resize=True, no_move=True, no_collapse=True, pos=(210, 600)):
